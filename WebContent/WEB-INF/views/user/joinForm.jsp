				...
				<div id="joinForm">
					<form action="/mysite2/user" method="get">
						...
						<div class="form-group">
							...
							<input type="radio" id="rdo-male" name="gender" value="male" > <!-- name을 같이 써야 -->
							
							<label for="rdo-female">여</label> 
							<input type="radio" id="rdo-female" name="gender" value="female" > <!-- 그룹이 하나로 묶인다 -->
						...
						<input type="text" name="action" value="join"> <!-- 파라미터 -->
					</form>
				</div>
				<!-- //joinForm -->
			</div>
